<template>
  <section class="py-5 mb-5">
    ...
    <div class="home-banner-two-auth pt-5">
      <div class="d-table">
  ...
  metaInfo() {
    return {
      ...
      meta: [
        ...
        {
          property: "og:image",
          content: this.post ? this.post.featured_image : "",
        },
        {
          property: "og:description",
          content: this.post ? this.post.summary : "",
        },
        { name: "twitter:card", content: "summary" },
        {
          name: "twitter:title",
          content: this.post ? this.post.meta.title : "",
        },
        {
...
"image": [
"https://backlinks.services${this.post.featured_image}"
],
