...
<section class="footer-section ptb-100" style="background-color: #304674 !important;">
    ...
    <div class="default-animation">
        <div class="shape-img1"><img src="/assets/img/shape/12.svg" alt="image">
        </div>
        <div class="shape-img2"><img src="/assets/img/shape/13.svg" alt="image">
        </div>
        <div class="shape-img3"><img src="/assets/img/shape/14.png" alt="image">
        </div>
        <div class="shape-img4"><img src="/assets/img/shape/15.png" alt="image">
        </div>
        <div class="shape-img5"><img src="/assets/img/shape/2.png" alt="image">
        </div>
    </div>
</section>
<!-- End Footer Section -->
